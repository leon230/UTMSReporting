SELECT DISTINCT
	...
	DENSE_RANK() OVER (PARTITION BY T_DECLINE.REJECTION_DATE, 
											T_DECLINE.REJECTION_DATE,
											T_DECLINE.TSP_ID
											
											ORDER BY CAST(From_tz(cast(T_DECLINE.REJECTION_DATE AS TIMESTAMP), 'GMT') AT TIME ZONE 'CET' AS DATE) ASC) 	TSP_REJECTIONS_PER_MONTH,
