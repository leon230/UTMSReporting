select * from ((SELECT DISTINCT SH.SHIPMENT_GID AS																														SH_ID,
	...
	/* 	(SELECT LISTAGG(SHR_RA.SHIPMENT_REFNUM_VALUE,'|') WITHIN GROUP (ORDER BY SHR_RA.SHIPMENT_GID)																										
		...
		AND ORLS_REF.ORDER_RELEASE_REFNUM_QUAL_GID = 'ULE.ULE_SERVICE_CRITICAL'
		)																																				SERVICE_CRITICAL,
		(
...
/* 		(
	...
	/* 	TO_CHAR(UTC.GET_LOCAL_DATE(ORLS.LATE_PICKUP_DATE,ORLS.SOURCE_LOCATION_GID),'YYYY-MM-DD HH24:MI')                                                LATE_PICKUP_DATE,
		...
		WHERE 1=1
				 ...
				 AND IESH_EVENT_DELIVER.STATUS_REASON_CODE_GID in ('ULE/PR.0002','ULE/PR.0006','ULE/PR.OTN','ULE/PR.0011','ULE/PR.0017','ULE/PR.0032','ULE/PR.0036','ULE/PR.0042'
				 ,'ULE/PR.0005','ULE/PR.0003','ULE/PR.0007','ULE/PR.0012','ULE/PR.0013','ULE/PR.0015','ULE/PR.0001','ULE/PR.0004','ULE/PR.0009')
