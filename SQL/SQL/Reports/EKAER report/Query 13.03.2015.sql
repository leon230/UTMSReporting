SELECT DISTINCT SH.SHIPMENT_GID AS																														SH_ID,
		...
		ORLS.SOURCE_LOCATION_GID AS																														or_SOURCE_LOC_ID,
		sh.SOURCE_LOCATION_GID																															sh_SOURCE_LOC_ID,
		LOC_SOURCE.CITY AS 																																or_SOURCE_CITY,
		LOC_SOURCE.COUNTRY_CODE3_GID																													or_SOURCE_COUNTRY,

		ORLS.DEST_LOCATION_GID	AS																														or_DEST_LOC_ID,
		sh.DEST_LOCATION_GID																															sh_DEST_LOC_ID,
		LOC_DEST.CITY AS 																																or_DESTINATION_CITY,
		LOC_DEST.COUNTRY_CODE3_GID																														or_DESTINATION_COUNTRY,
