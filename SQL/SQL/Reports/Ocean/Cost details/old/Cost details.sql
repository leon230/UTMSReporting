select distinct (SELECT TO_CHAR(SH_TEMP.START_TIME,'DD-MM-YYYY')
		...
		(select LISTAGG((select ii.INVOICE_NUMBER from invoice ii where ii.INVOICE_GID =ivsh.INVOICE_GID ),'|') WITHIN GROUP (ORDER BY VORLS.shipment_gid)
		...
		trim(nvl((SELECT TO_CHAR((SUM(CASE
				WHEN OR_COST_TEMP.COST_CURRENCY_GID = 'EUR' THEN OR_COST_TEMP.COST
				ELSE NVL2(OR_COST_TEMP.COST * EXCHRATES.EXCHANGE_RATE, 
				OR_COST_TEMP.COST * EXCHRATES.EXCHANGE_RATE, 0)
				END)),'999999999999D99','NLS_NUMERIC_CHARACTERS = '', ''')
				
				FROM allocation_or_line_d OR_COST_TEMP
				LEFT OUTER JOIN CURRENCY_EXCHANGE_RATE EXCHRATES ON (TO_CHAR(OR_COST_TEMP.INSERT_DATE, 'Q-YYYY') = TO_CHAR(EXCHRATES.EFFECTIVE_DATE, 'Q-YYYY') 
				AND OR_COST_TEMP.COST_CURRENCY_GID = EXCHRATES.FROM_CURRENCY_GID 
				AND EXCHRATES.EXCHANGE_RATE_GID = 'ULE.ULE_QTY_EXCHANGE' 
				AND EXCHRATES.TO_CURRENCY_GID = 'EUR'),
				Order_release_line ORLSL_TEMP
				/* invoice_lineitem iv, */
				/* INVOICE_LINEITEM_COST_REF ilcr */
				
				WHERE OR_COST_TEMP.ORDER_RELEASE_LINE_GID=ORLSL_TEMP.ORDER_RELEASE_LINE_GID
				/* AND ORLSL_TEMP.order_release_line_gid=orlsl.order_release_line_gid */
			/* 	and iv.invoice_gid=ilcr.invoice_gid
				and iv.LINEITEM_SEQ_NO = ilcr.LINEITEM_SEQ_NO
				and ilcr.COST_REFERENCE_GID = orlsl_temp.ORDER_RELEASE_LINE_GID */
				and orlsl_temp.order_release_line_gid=orlsl.order_release_line_gid
				/* and ilcr.COST_REFERENCE_GID = OR_COST_TEMP.order_release_line_gid */
				
				AND	(OR_COST_TEMP.COST_DESCRIPTION ='B'  or
				 OR_COST_TEMP.ACCESSORIAL_CODE_GID in ('UGO.UGO_BAS'))
				 /* and (iv.DESCRIPTION ='BAS' or iv.ACCESSORIAL_CODE_GID is null) */

				GROUP BY ORLSL_TEMP.ORDER_RELEASE_gid
				),0))																																			BASE_COST_BAS,
	/* 		(select SUM(OR_COST_TEMP.COST)
				...
				WHERE 
				ilcr.COST_REFERENCE_GID = orlsl_temp.ORDER_RELEASE_LINE_GID
				and orlsl_temp.order_release_line_gid=orlsl.order_release_line_gid
				and ilcr.COST_REFERENCE_GID = OR_COST_TEMP.order_release_line_gid
				and iv.invoice_gid=ilcr.invoice_gid
				...
				AND	(OR_COST_TEMP.COST_DESCRIPTION ='B'  or
				 OR_COST_TEMP.ACCESSORIAL_CODE_GID in ('UGO.UGO_BAS'))
				 and iv.DESCRIPTION ='BAS'

				GROUP BY orlsl_temp.order_release_line_gid
				...
				WHERE OR_COST_TEMP.ORDER_RELEASE_LINE_GID=ORLSL_TEMP.ORDER_RELEASE_LINE_GID
				AND ORLSL_TEMP.order_release_line_gid=orlsl.order_release_line_gid
				AND	OR_COST_TEMP.ACCESSORIAL_CODE_GID in ('UGO.UGO_BAF')
				...
				WHERE OR_COST_TEMP.ORDER_RELEASE_LINE_GID=ORLSL_TEMP.ORDER_RELEASE_LINE_GID
				AND ORLSL_TEMP.order_release_line_gid=orlsl.order_release_line_gid
				AND	OR_COST_TEMP.ACCESSORIAL_CODE_GID in ('UGO.UGO_DTHC')
				...
				WHERE OR_COST_TEMP.ORDER_RELEASE_LINE_GID=ORLSL_TEMP.ORDER_RELEASE_LINE_GID
				AND ORLSL_TEMP.order_release_line_gid=orlsl.order_release_line_gid
				AND	OR_COST_TEMP.ACCESSORIAL_CODE_GID in ('UGO.UGO_OTHC')
				...
				WHERE OR_COST_TEMP.ORDER_RELEASE_LINE_GID=ORLSL_TEMP.ORDER_RELEASE_LINE_GID
				AND ORLSL_TEMP.order_release_line_gid=orlsl.order_release_line_gid
				AND	OR_COST_TEMP.ACCESSORIAL_CODE_GID in ('UGO.UGO_INLAND_ORIGIN')
				...
				WHERE OR_COST_TEMP.ORDER_RELEASE_LINE_GID=ORLSL_TEMP.ORDER_RELEASE_LINE_GID
				AND ORLSL_TEMP.order_release_line_gid=orlsl.order_release_line_gid
				AND	OR_COST_TEMP.ACCESSORIAL_CODE_GID in ('UGO.UGO_INLAND_DESTINATION')

				GROUP BY ORLSL_TEMP.ORDER_RELEASE_gid
				),0))																																			UINLAND_DESTINATION,
				trim(nvl((SELECT TO_CHAR((SUM(CASE
				WHEN OR_COST_TEMP.COST_CURRENCY_GID = 'EUR' THEN OR_COST_TEMP.COST
				ELSE NVL2(OR_COST_TEMP.COST * EXCHRATES.EXCHANGE_RATE, 
				OR_COST_TEMP.COST * EXCHRATES.EXCHANGE_RATE, 0)
				...
				WHERE OR_COST_TEMP.ORDER_RELEASE_LINE_GID=ORLSL_TEMP.ORDER_RELEASE_LINE_GID
				AND ORLSL_TEMP.order_release_line_gid=orlsl.order_release_line_gid
				AND	OR_COST_TEMP.ACCESSORIAL_CODE_GID in ('UGO.UGO_FCL_FREIGHT_COST_CORRECTION')

				GROUP BY ORLSL_TEMP.ORDER_RELEASE_gid
				),0))																																			FCL_FREIGHT_COST_CORR,
			...
			trim(nvl((SELECT TO_CHAR((SUM(CASE
				...
				WHERE OR_COST_TEMP.ORDER_RELEASE_LINE_GID=ORLSL_TEMP.ORDER_RELEASE_LINE_GID
				AND ORLSL_TEMP.order_release_line_gid=orlsl.order_release_line_gid
				AND	OR_COST_TEMP.ACCESSORIAL_CODE_GID in ('UGO.UGO_ADDITIONAL_DISTANCE')
				...
				WHERE OR_COST_TEMP.ORDER_RELEASE_LINE_GID=ORLSL_TEMP.ORDER_RELEASE_LINE_GID
				AND ORLSL_TEMP.order_release_line_gid=orlsl.order_release_line_gid
				AND	OR_COST_TEMP.ACCESSORIAL_CODE_GID in ('UGO.UGO_ALL_IN_RATE')
				...
				WHERE OR_COST_TEMP.ORDER_RELEASE_LINE_GID=ORLSL_TEMP.ORDER_RELEASE_LINE_GID
				AND ORLSL_TEMP.order_release_line_gid=orlsl.order_release_line_gid
				AND	OR_COST_TEMP.ACCESSORIAL_CODE_GID in ('UGO.UGO_CANCELLATION_COST')
				...
				WHERE OR_COST_TEMP.ORDER_RELEASE_LINE_GID=ORLSL_TEMP.ORDER_RELEASE_LINE_GID
				AND ORLSL_TEMP.order_release_line_gid=orlsl.order_release_line_gid
				AND	OR_COST_TEMP.ACCESSORIAL_CODE_GID in ('UGO.UGO_CONTAINER_COOLING')
				...
				WHERE OR_COST_TEMP.ORDER_RELEASE_LINE_GID=ORLSL_TEMP.ORDER_RELEASE_LINE_GID
				AND ORLSL_TEMP.order_release_line_gid=orlsl.order_release_line_gid
				AND	OR_COST_TEMP.ACCESSORIAL_CODE_GID in ('UGO.UGO_CREDIT_NOTE')
				...
				WHERE OR_COST_TEMP.ORDER_RELEASE_LINE_GID=ORLSL_TEMP.ORDER_RELEASE_LINE_GID
				AND ORLSL_TEMP.order_release_line_gid=orlsl.order_release_line_gid
				AND	OR_COST_TEMP.ACCESSORIAL_CODE_GID in ('UGO.UGO_CUSTOM_CLEARANCE_EXPORT')

				GROUP BY ORLSL_TEMP.ORDER_RELEASE_gid
				),0))																																			CUSTOMS_CLEARANCE_EXPORT,
				trim(nvl((SELECT TO_CHAR((SUM(CASE
				WHEN OR_COST_TEMP.COST_CURRENCY_GID = 'EUR' THEN OR_COST_TEMP.COST
				ELSE NVL2(OR_COST_TEMP.COST * EXCHRATES.EXCHANGE_RATE, 
				OR_COST_TEMP.COST * EXCHRATES.EXCHANGE_RATE, 0)
				...
				WHERE OR_COST_TEMP.ORDER_RELEASE_LINE_GID=ORLSL_TEMP.ORDER_RELEASE_LINE_GID
				AND ORLSL_TEMP.order_release_line_gid=orlsl.order_release_line_gid
				AND	OR_COST_TEMP.ACCESSORIAL_CODE_GID in ('UGO.UGO_CUSTOM_CLEARANCE_IMPORT')

				GROUP BY ORLSL_TEMP.ORDER_RELEASE_gid
				),0))																																			CUSTOMS_CLEARANCE_IMPORT,
				trim(nvl((SELECT TO_CHAR((SUM(CASE
				WHEN OR_COST_TEMP.COST_CURRENCY_GID = 'EUR' THEN OR_COST_TEMP.COST
				ELSE NVL2(OR_COST_TEMP.COST * EXCHRATES.EXCHANGE_RATE, 
				OR_COST_TEMP.COST * EXCHRATES.EXCHANGE_RATE, 0)
				...
				WHERE OR_COST_TEMP.ORDER_RELEASE_LINE_GID=ORLSL_TEMP.ORDER_RELEASE_LINE_GID
				AND ORLSL_TEMP.order_release_line_gid=orlsl.order_release_line_gid
				AND	OR_COST_TEMP.ACCESSORIAL_CODE_GID in ('UGO.UGO_DEMURRAGE_AT_CUSTOMS')

				GROUP BY ORLSL_TEMP.ORDER_RELEASE_gid
				),0))																																			DEMURRAGE_AT_CUSTOMS,
				trim(nvl((SELECT TO_CHAR((SUM(CASE
				WHEN OR_COST_TEMP.COST_CURRENCY_GID = 'EUR' THEN OR_COST_TEMP.COST
				ELSE NVL2(OR_COST_TEMP.COST * EXCHRATES.EXCHANGE_RATE, 
				OR_COST_TEMP.COST * EXCHRATES.EXCHANGE_RATE, 0)
				...
				WHERE OR_COST_TEMP.ORDER_RELEASE_LINE_GID=ORLSL_TEMP.ORDER_RELEASE_LINE_GID
				AND ORLSL_TEMP.order_release_line_gid=orlsl.order_release_line_gid
				AND	OR_COST_TEMP.ACCESSORIAL_CODE_GID in ('UGO.UGO_DEMURRAGE_AT_TERMINAL')

				GROUP BY ORLSL_TEMP.ORDER_RELEASE_gid
				),0))																																			DEMURRAGE_AT_terminal,
				trim(nvl((SELECT TO_CHAR((SUM(CASE
				WHEN OR_COST_TEMP.COST_CURRENCY_GID = 'EUR' THEN OR_COST_TEMP.COST
				ELSE NVL2(OR_COST_TEMP.COST * EXCHRATES.EXCHANGE_RATE, 
				OR_COST_TEMP.COST * EXCHRATES.EXCHANGE_RATE, 0)
				...
				WHERE OR_COST_TEMP.ORDER_RELEASE_LINE_GID=ORLSL_TEMP.ORDER_RELEASE_LINE_GID
				AND ORLSL_TEMP.order_release_line_gid=orlsl.order_release_line_gid
				AND	OR_COST_TEMP.ACCESSORIAL_CODE_GID in ('UGO.UGO_DEMURRAGE_AT_THE_PORT')

				GROUP BY ORLSL_TEMP.ORDER_RELEASE_gid
				),0))																																			DEMURRAGE_AT_THE_PORT,
				trim(nvl((SELECT TO_CHAR((SUM(CASE
				WHEN OR_COST_TEMP.COST_CURRENCY_GID = 'EUR' THEN OR_COST_TEMP.COST
				ELSE NVL2(OR_COST_TEMP.COST * EXCHRATES.EXCHANGE_RATE, 
				OR_COST_TEMP.COST * EXCHRATES.EXCHANGE_RATE, 0)
				...
				WHERE OR_COST_TEMP.ORDER_RELEASE_LINE_GID=ORLSL_TEMP.ORDER_RELEASE_LINE_GID
				AND ORLSL_TEMP.order_release_line_gid=orlsl.order_release_line_gid
				AND	OR_COST_TEMP.ACCESSORIAL_CODE_GID in ('UGO.UGO_DEMURRAGE_LOADING_COST')

				GROUP BY ORLSL_TEMP.ORDER_RELEASE_gid
				),0))																																			DEMURRAGE_LOADING_COST,
				trim(nvl((SELECT TO_CHAR((SUM(CASE
				WHEN OR_COST_TEMP.COST_CURRENCY_GID = 'EUR' THEN OR_COST_TEMP.COST
				ELSE NVL2(OR_COST_TEMP.COST * EXCHRATES.EXCHANGE_RATE, 
				OR_COST_TEMP.COST * EXCHRATES.EXCHANGE_RATE, 0)
				...
				WHERE OR_COST_TEMP.ORDER_RELEASE_LINE_GID=ORLSL_TEMP.ORDER_RELEASE_LINE_GID
				AND ORLSL_TEMP.order_release_line_gid=orlsl.order_release_line_gid
				AND	OR_COST_TEMP.ACCESSORIAL_CODE_GID in ('UGO.UGO_DEMURRAGE_UNLOADING_COST')

				GROUP BY ORLSL_TEMP.ORDER_RELEASE_gid
				),0))																																			DEMURRAGE_UNLOADING_COST,
				trim(nvl((SELECT TO_CHAR((SUM(CASE
				WHEN OR_COST_TEMP.COST_CURRENCY_GID = 'EUR' THEN OR_COST_TEMP.COST
				ELSE NVL2(OR_COST_TEMP.COST * EXCHRATES.EXCHANGE_RATE, 
				OR_COST_TEMP.COST * EXCHRATES.EXCHANGE_RATE, 0)
				...
				WHERE OR_COST_TEMP.ORDER_RELEASE_LINE_GID=ORLSL_TEMP.ORDER_RELEASE_LINE_GID
				AND ORLSL_TEMP.order_release_line_gid=orlsl.order_release_line_gid
				AND	OR_COST_TEMP.ACCESSORIAL_CODE_GID in ('UGO.UGO_DETENTION')
				...
				WHERE OR_COST_TEMP.ORDER_RELEASE_LINE_GID=ORLSL_TEMP.ORDER_RELEASE_LINE_GID
				AND ORLSL_TEMP.order_release_line_gid=orlsl.order_release_line_gid
				AND	OR_COST_TEMP.ACCESSORIAL_CODE_GID in ('UGO.UGO_DG_SURCHARGE')
				...
				WHERE OR_COST_TEMP.ORDER_RELEASE_LINE_GID=ORLSL_TEMP.ORDER_RELEASE_LINE_GID
				AND ORLSL_TEMP.order_release_line_gid=orlsl.order_release_line_gid
				AND	OR_COST_TEMP.ACCESSORIAL_CODE_GID in ('UGO.UGO_DOCUMENTATION_COST')

				GROUP BY ORLSL_TEMP.ORDER_RELEASE_gid
				),0))																																			DOCUMENTATION_COST,
				trim(nvl((SELECT TO_CHAR((SUM(CASE
				WHEN OR_COST_TEMP.COST_CURRENCY_GID = 'EUR' THEN OR_COST_TEMP.COST
				ELSE NVL2(OR_COST_TEMP.COST * EXCHRATES.EXCHANGE_RATE, 
				OR_COST_TEMP.COST * EXCHRATES.EXCHANGE_RATE, 0)
				...
				WHERE OR_COST_TEMP.ORDER_RELEASE_LINE_GID=ORLSL_TEMP.ORDER_RELEASE_LINE_GID
				AND ORLSL_TEMP.order_release_line_gid=orlsl.order_release_line_gid
				AND	OR_COST_TEMP.ACCESSORIAL_CODE_GID in ('UGO.UGO_PICK_UP_FEE')
				...
				WHERE OR_COST_TEMP.ORDER_RELEASE_LINE_GID=ORLSL_TEMP.ORDER_RELEASE_LINE_GID
				AND ORLSL_TEMP.order_release_line_gid=orlsl.order_release_line_gid
				AND	OR_COST_TEMP.ACCESSORIAL_CODE_GID in ('UGO.UGO_STORAGE_COSTS')
				...
				WHERE OR_COST_TEMP.ORDER_RELEASE_LINE_GID=ORLSL_TEMP.ORDER_RELEASE_LINE_GID
				AND ORLSL_TEMP.order_release_line_gid=orlsl.order_release_line_gid
				AND	OR_COST_TEMP.ACCESSORIAL_CODE_GID in ('UGO.UGO_TERMINAL_HANDLING_COST')

				GROUP BY ORLSL_TEMP.ORDER_RELEASE_gid
				),0))																																			TERMINAL_HANDLING_COST,
				trim(nvl((SELECT TO_CHAR((SUM(CASE
				WHEN OR_COST_TEMP.COST_CURRENCY_GID = 'EUR' THEN OR_COST_TEMP.COST
				ELSE NVL2(OR_COST_TEMP.COST * EXCHRATES.EXCHANGE_RATE, 
				OR_COST_TEMP.COST * EXCHRATES.EXCHANGE_RATE, 0)
				...
				WHERE OR_COST_TEMP.ORDER_RELEASE_LINE_GID=ORLSL_TEMP.ORDER_RELEASE_LINE_GID
				AND ORLSL_TEMP.order_release_line_gid=orlsl.order_release_line_gid
				AND	OR_COST_TEMP.ACCESSORIAL_CODE_GID in ('UGO.UGO_CONTAINER_STUFFING_DESTUFFING','UGO.UGO_OVERWEIGHT_SURCHARGE','')
...
/* and VORLS.shipment_gid in ('UGO.10001997') */
--10003984
