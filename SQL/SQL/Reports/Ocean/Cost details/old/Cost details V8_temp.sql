SELECT DISTINCT (SELECT TO_CHAR(SH_TEMP.START_TIME,'DD-MM-YYYY')
		...
		(SELECT LISTAGG(ORLS_REF.ORDER_RELEASE_REFNUM_VALUE,'/') WITHIN GROUP (ORDER BY ORLS_REF.ORDER_RELEASE_GID)
				...
				and ORLSL_t.ORDER_RELEASE_LINE_GID = ORLSL.ORDER_RELEASE_LINE_GID
				...
				INVOICE_LINEITEM_COST_REF ILCR_t,
				 invoice_shipment inv_sh
				
				WHERE ILCR_t.INVOICE_GID = INV_LINE.INVOICE_GID
				AND OR_LINE.ORDER_RELEASE_GID = ORLS.ORDER_RELEASE_GID
				and inv_sh.shipment_gid = sh.shipment_gid
				and inv_sh.INVOICE_GID = INV_LINE.INVOICE_GID
				AND INV_LINE.LINEITEM_SEQ_NO = ILCR_t.LINEITEM_SEQ_NO
