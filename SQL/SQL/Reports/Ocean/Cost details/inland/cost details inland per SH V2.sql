SELECT DISTINCT TO_CHAR(SH.END_TIME,'DD-MM-YYYY')																												SHIPMENT_END_DATE,
...
/* 		(SELECT LISTAGG(II.INVOICE_NUMBER,'/') WITHIN GROUP (ORDER BY ORLS.ORDER_RELEASE_GID)
		...
		WHERE ORLSL_TEMP.ORDER_RELEASE_LINE_GID = ILCR.	COST_REFERENCE_GID
			...
			/* 	TRIM(NVL((SELECT TO_CHAR((SUM(CASE
				...
				AND EXCHRATES.TO_CURRENCY_GID = 'EUR')
				WHERE SH_COST_TEMP.SHIPMENT_GID=SH.SHIPMENT_GID
				AND	(COST_TYPE = 'A' AND ACCESSORIAL_CODE_GID IN ('UGO.FUEL_SURCHARGE_BULK_OCEAN_24','UGO.FUEL_SURCHARGE_INTERMODAL_BULK_OCEAN_25'))
				...
				AND EXCHRATES.TO_CURRENCY_GID = 'EUR')
				WHERE SH_COST_TEMP.SHIPMENT_GID=SH.SHIPMENT_GID
				AND	(COST_TYPE = 'A' AND ACCESSORIAL_CODE_GID NOT IN ('UGO.UGO_WEEKEND_COST','UGO.TERMINAL_CHANGE',
				'UGO.UGO_STORAGE_COSTS','UGO.UGO_TANK_CHASSIS_HIRE','UGO.UGO_PICK_UP_FEE','UGO.SECOND_DRIVER','UGO.UGO_DOCUMENTATION_COST','UGO.UGO_DG_SURCHARGE',
				'UGO.UGO_DEMURRAGE_UNLOADING_COST','UGO.UGO_DETENTION','UGO.UGO_HEATING_COSTS','UGO.UGO_DEMURRAGE_LOADING_COST','UGO.UGO_DEMURRAGE_AT_TERMINAL',
				'UGO.UGO_DEMURRAGE_AT_CUSTOMS','UGO.UGO_CUSTOM_CLEARANCE_IMPORT','UGO.UGO_CUSTOM_CLEARANCE_EXPORT','UGO.UGO_CREDIT_NOTE','UGO.UGO_CONTAINER_COOLING',
				'UGO.UGO_CANCELLATION_COST','UGO.UGO_ADDITIONAL_CLEANING_REQUIRED','UGO.LTL_FREIGHTCOST_CORRECTION','UGO.UGO_FUEL_SURCHARGE_ORIGIN','UGO.UGO_FUEL_SURCHARGE_DESTINATION',
				'UGO.UGO_FUEL_SURCHARGE_CORRECTION','UGO.FUEL_SURCHARGE_BULK_OCEAN_24','UGO.FUEL_SURCHARGE_INTERMODAL_BULK_OCEAN_25','UGO.UGO_FTL_FREIGHT_COST_CORRECTION',
				'UGO.UGO_FCL_FREIGHT_COST_CORRECTION','UGO.UGO_FREIGHT_COST_BASIC_FTL','UGO.UGO_TERMINAL_HANDLING_COST','UGO.UGO_ADDITIONAL_DISTANCE','UGO.UGO_ALL_IN_RATE'))
...
/* AND SH.END_TIME BETWEEN TO_DATE('01-09-2014','DD-MM-YYYY') AND TO_DATE('30-09-2014','DD-MM-YYYY') */

AND SH.END_TIME BETWEEN TO_DATE(:P_END_TIME_FROM,:P_DATE_TIME_FORMAT) AND TO_DATE(:P_END_TIME_TO,:P_DATE_TIME_FORMAT)
