...
--total cost ???
---------16.05.2016-------------------------------------------------------------------------------
-- missing cat then from source loc
-- sending loc for FG // receiving RP if missing
-- add silo and tanker restriction ???
--------------------06.07.2016-----------------
--TODO weight capacity restriction for chosen equipment
--TODO number of shipments to category,lanes
--TODO round PFS
--TODO jesli jedna dodatkowa paleta > truck weight capacity -> 100% waga
