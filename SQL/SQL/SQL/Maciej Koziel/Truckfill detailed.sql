...
,to_char(ROUND(sh.TOTAL_VOLUME_BASE*0.02831685,5))                                                                                                           TOTAL_VOLUME_CUM
,(SELECT or_ref.order_release_refnum_value
FROM order_release_refnum or_ref
WHERE or_ref.order_release_refnum_qual_gid = 'ULE.ULE_UNPLANNED_ICT'
...
,ssul.packaged_item_gid                                                                                                                 s_packaged_item
,''                                                                                                                  packaged_item
,''                                                                                                               it_count
,ssul.item_package_count                                                                                                                s_it_count
,su.ship_unit_count
...
LEFT OUTER JOIN s_ship_unit_line ssul ON (ssul.ship_unit_gid = sul.ship_unit_gid
and sul.ship_unit_line_no = ssul.ship_unit_line_no)
...
,RD.UNPLANNED_ICT                                                                                                                                              UNPLANNED_ICT
...
,rd.order_release_gid
,rd.transport_handling_unit_gid
,rd.s_ship_unit_gid
,rd.s_packaged_item                                                                                                                 s_packaged_item
,rd.packaged_item                                                                                                                  packaged_item
,rd.it_count                                                                                                                 it_count
,rd.s_it_count                                                                                                                s_it_count
,rd.ship_unit_count
,ROUND(rd.weight_ship_unit*0.45359237,2)                                                                                         weight_ship_unit
,ROUND(rd.item_weight*0.45359237,2)                                                                                                    item_weight
...
--AND sh.start_time >= to_date('2016-07-01','YYYY-MM-DD')
--AND sh.start_time < to_date('2016-07-15','YYYY-MM-DD')
--and rownum < 3
